...
int MO_SelectMOShotCycleTime(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString);
int MO_SelectCustomSensorSN_TableSN(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString);
...
int MO_SelectCustomSensorSNList(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString);
int MO_JSON_SetMOList(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_JSON_UpdateMOList(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_JSON_UpdateMOConfigAllMonitorItemSN(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_JSON_SetMOLotNum(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_JSON_SetMOStart(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_JSON_SetMOStop(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_JSON_SetSPCRuleAlarmRead(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_JSON_SetSPCQCAlarmRead(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_JSON_ResetOPCUA(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_SelectSPCName(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString);
...
int INDEX_JSON_SetSPCRuleCL(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int INDEX_JSON_SetSPCQCCL(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int INDEX_JSON_SetMOAcceptCriteriaActualValue(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int INDEX_JSON_SetMOAcceptCriteriaActualValue_Actual(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int INDEX_JSON_SetMOAcceptCriteriaActualValue_Predict(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int INDEX_JSON_InsertIMMList(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int INDEX_JSON_UpdateIMMList(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int INDEX_JSON_SetSPCRule(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int INDEX_JSON_SetSPCQC(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int INDEX_JSON_SetPrimaryIMM(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_CheckIsomorphismbyMOSN(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_SPC_CopySPCControlLine(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_QC_CopyQCControlLine(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_EC_CopyECControlLine(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_SPC_CopySPCAllMonitorItemSN(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
int MO_QC_CopyQCAllMonitorItemSN(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP);
//  Function List  End
...
int main(void)
{
	...
	while (FCGX_Accept_r(&fcgxRequest) == 0) //Start Listen request
	{
		...
		case HTTP_REQUEST_TYPE_GET:
		{
			...
			else if (strcmp(charRequestURI, "/injpro/data/CustomSensorSN_TableSN/get/") == 0)
			{
				jsonResponseHTTP = json_object_new_object();
				fprintf(stderr, "GET:%s\n", json_object_to_json_string(jsonResponseHTTP));
				MO_SelectCustomSensorSN_TableSN(mysqlCon, jsonResponseHTTP, charQueryString);
				FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
				json_object_put(jsonResponseHTTP);
			}
			...
			else if (strcmp(charRequestURI, "/injpro/data/CustomSensorSNList/get/") == 0)
			{
				// int MO_SelectCustomSensorSNList(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString)
				jsonResponseHTTP = json_object_new_object();
				MO_SelectCustomSensorSNList(mysqlCon, jsonResponseHTTP, charQueryString);
				FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
				json_object_put(jsonResponseHTTP);
			}
			else if (strcmp(charRequestURI, "/injpro/data/CycleTime/get/") == 0)
			{
				jsonResponseHTTP = json_object_new_object();
				MO_SelectMOShotCycleTime(mysqlCon, jsonResponseHTTP, charQueryString);
				FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
				json_object_put(jsonResponseHTTP);
			}
			else if (strcmp(charRequestURI, "/injpro/data/SPCName/get/") == 0)
			{
				jsonResponseHTTP = json_object_new_object();
				MO_SelectSPCName(mysqlCon, jsonResponseHTTP, charQueryString);
				FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
				json_object_put(jsonResponseHTTP);
			}
		...
		case HTTP_REQUEST_TYPE_POST:
		{
			...
			else
			{
				...
				//	free(charContentData);
				//}
				else if (strcmp(charRequestURI, "/injpro/UpdateIMMList/set/") == 0)
				{
					jsonResponseHTTP = json_object_new_object();
					snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_UpdateIMMList]===========================");
					INDEX_JSON_UpdateIMMList(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/InsertIMMList/set/") == 0)
				{
					jsonResponseHTTP = json_object_new_object();
					snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_InsertIMMList]===========================");
					INDEX_JSON_InsertIMMList(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				...
				else if (strcmp(charRequestURI, "/injpro/SPCQC/set/") == 0)
				{
                    // int SPC_EnableSPCSNRule(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intSPCSN, bool boolSPCRule[8]);
					jsonResponseHTTP = json_object_new_object();
					INDEX_JSON_SetSPCQC(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/PrimaryIMM/set/") == 0)
				{
                    // int IMM_SetPrimaryIMM(MYSQL mysqlCon, unsigned int intIMMSN)
					jsonResponseHTTP = json_object_new_object();
					INDEX_JSON_SetPrimaryIMM(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/CheckIsomorphism/set/") == 0)
				{
                    // int IMM_SetPrimaryIMM(MYSQL mysqlCon, unsigned int intIMMSN)
					jsonResponseHTTP = json_object_new_object();
					MO_CheckIsomorphismbyMOSN(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/CopySPCControlLine/set/") == 0)
				{
                    // int IMM_SetPrimaryIMM(MYSQL mysqlCon, unsigned int intIMMSN)
					jsonResponseHTTP = json_object_new_object();
					MO_SPC_CopySPCControlLine(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/CopySPCAllMonitorItemSN/set/") == 0)
				{
                    // int IMM_SetPrimaryIMM(MYSQL mysqlCon, unsigned int intIMMSN)
					jsonResponseHTTP = json_object_new_object();
					MO_SPC_CopySPCAllMonitorItemSN(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/CopyQCControlLine/set/") == 0)
				{
                    // int IMM_SetPrimaryIMM(MYSQL mysqlCon, unsigned int intIMMSN)
					jsonResponseHTTP = json_object_new_object();
					MO_QC_CopyQCControlLine(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/CopyQCAllMonitorItemSN/set/") == 0)
				{
                    // int IMM_SetPrimaryIMM(MYSQL mysqlCon, unsigned int intIMMSN)
					jsonResponseHTTP = json_object_new_object();
					MO_QC_CopyQCAllMonitorItemSN(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/CopyECControlLine/set/") == 0)
				{
                    // int IMM_SetPrimaryIMM(MYSQL mysqlCon, unsigned int intIMMSN)
					jsonResponseHTTP = json_object_new_object();
					MO_EC_CopyECControlLine(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/SPCRule/set/") == 0)
				{
                    // int SPC_EnableSPCSNRule(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intSPCSN, bool boolSPCRule[8]);
					jsonResponseHTTP = json_object_new_object();
					INDEX_JSON_SetSPCRule(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/SPCRuleIndex/set/") == 0)
				{
					// int INDEX_JSON_SetSPCRuleCL(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
					fprintf(stderr, "[Bermuda]SPCCL\n");
					jsonResponseHTTP = json_object_new_object();
					INDEX_JSON_SetSPCRuleCL(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/SPCQCIndex/set/") == 0)
				{
					// int INDEX_JSON_SetSPCQCCL(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
					fprintf(stderr, "[Bermuda]SPCCL\n");
					jsonResponseHTTP = json_object_new_object();
					INDEX_JSON_SetSPCQCCL(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/MOList/update/") == 0)
				{
					// int MO_JSON_SetMOList(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
					jsonResponseHTTP = json_object_new_object();
					MO_JSON_UpdateMOList(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				...
				else if (strcmp(charRequestURI, "/injpro/ResetOPCUA/set/") == 0)
				{
				    //int OPCUA_ResetOPCUAServer(MYSQL mysqlCon, unsigned int intIMMSN)
					jsonResponseHTTP = json_object_new_object();
					MO_JSON_ResetOPCUA(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/MOConfigAllMonitorItemSN/set/") == 0)
				{
					...
					jsonResponseHTTP = json_object_new_object();
					MO_JSON_UpdateMOConfigAllMonitorItemSN(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/MOLotNum/set/") == 0)
				{
					//int DB_UpdateCustomSN(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intShotSN, unsigned int intCustomSN)
					jsonResponseHTTP = json_object_new_object();
					MO_JSON_SetMOLotNum(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/MOStart/set/") == 0)
				{
					//int MO_StartMOonIMM(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intIMMSN);
					jsonResponseHTTP = json_object_new_object();
					MO_JSON_SetMOStart(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/MOStop/set/") == 0)
				{
//					int MO_StopMOonIMM(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intIMMSN);
					jsonResponseHTTP = json_object_new_object();
					MO_JSON_SetMOStop(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/SPCRuleRead/set/") == 0)
				{
                    //int DB_UpdateSPCRuleAlarmRead(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intSPCRuleAlarmSN,bool boolSPCRuleAlarmRead);
					jsonResponseHTTP = json_object_new_object();
					MO_JSON_SetSPCRuleAlarmRead(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/SPCQCRead/set/") == 0)
				{
                    //int DB_UpdateSPCQCAlarmRead(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intSPCQCAlarmSN, bool boolSPCQCAlarmRead);
					jsonResponseHTTP = json_object_new_object();
					MO_JSON_SetSPCQCAlarmRead(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/MOAcceptCriteriaSN/set/") == 0)
				{
					// int INDEX_JSON_SetMOAcceptCriteriaActualValue(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
					jsonResponseHTTP = json_object_new_object();
					INDEX_JSON_SetMOAcceptCriteriaActualValue(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/MOAcceptCriteriaSN/Actual/set/") == 0)
				{
					// int INDEX_JSON_SetMOAcceptCriteriaActualValue(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
					jsonResponseHTTP = json_object_new_object();
					INDEX_JSON_SetMOAcceptCriteriaActualValue_Actual(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
				else if (strcmp(charRequestURI, "/injpro/MOAcceptCriteriaSN/Predict/set/") == 0)
				{
					// int INDEX_JSON_SetMOAcceptCriteriaActualValue(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
					jsonResponseHTTP = json_object_new_object();
					INDEX_JSON_SetMOAcceptCriteriaActualValue_Predict(mysqlCon, charContentData, jsonResponseHTTP);
					FCGX_PutS(json_object_to_json_string(jsonResponseHTTP), fcgxRequest.out);
					json_object_put(jsonResponseHTTP);
					free(charContentData);
				}
...
int regexGetRequestQueryString_SPCSN(char *charQueryString)
{
	unsigned int intSPCSN;
	regex_t reg;
	const size_t nmatch = 1;
	regmatch_t pmatch[1];
	const char *pattern = "spcsn=[^&]+";
	char *regresult;
	int status;
...
int INDEX_JSON_SetSPCQCCL(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetSPCQCCL]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_SetSPCQCCL] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		//intRetval = SPC_InsertAllSPCQCCL(mysqlCon, json_object_get_int(jsonMOSN), json_object_get_int(jsonShotSNStart), json_object_get_int(jsonShotSNEnd));
		intRetval = QC_InsertAllQCCL(mysqlCon, json_object_get_int(jsonMOSN), json_object_get_int(jsonShotSNStart), json_object_get_int(jsonShotSNEnd));

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_SetSPCQCCL] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetSPCQCCL]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_SetSPCQCCL] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
/*
    複製SPC管制界線與特徵值
    Args:
        1.MOSN_Source: 要複製的製令來源
        2.MOSN_Destination: 要複製到那張製令
    return:
        SUCCESS
*/
	char charErrMsg[LONG_STRING_SIZE];
	...
	struct json_object *jsoncharContentDataList;
	struct json_object *jsonMOSN_Source;
	struct json_object *jsonMOSN_Destination;

	snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SPC_CopySPCAllMonitorItemSN]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_SPC_CopySPCAllMonitorItemSN] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN_Source", &jsonMOSN_Source);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN_Destination", &jsonMOSN_Destination);

		fprintf(stderr, "Source:%d,Destination:%d\n", json_object_get_int(jsonMOSN_Source), json_object_get_int(jsonMOSN_Destination));
//      int SPC_CopyAllMonitorItemSN(MYSQL mysqlCon, unsigned int intSourceMOSN, unsigned int intDestinationMOSN)
		intRetval = SPC_CopyAllMonitorItemSN(mysqlCon, json_object_get_int(jsonMOSN_Source), json_object_get_int(jsonMOSN_Destination));

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_SPC_CopySPCAllMonitorItemSN] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SPC_CopySPCAllMonitorItemSN]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_SPC_CopySPCAllMonitorItemSN] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
*/
	...
	snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SPC_CopySPCControlLine]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_SPC_CopySPCControlLine] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
...
//      int SPC_CopySPCControlLine(MYSQL mysqlCon, unsigned int intSourceMOSN, unsigned int intDestinationMOSN)
		...
		fprintf(stderr, "Source:%d,Destination:%d\n", json_object_get_int(jsonMOSN_Source), json_object_get_int(jsonMOSN_Destination));
		intRetval = SPC_CopySPCControlLine(mysqlCon, json_object_get_int(jsonMOSN_Source), json_object_get_int(jsonMOSN_Destination));

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_SPC_CopySPCControlLine] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SPC_CopySPCControlLine]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_SPC_CopySPCControlLine] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
*/
	...
	snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_QC_CopyQCAllMonitorItemSN]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_QC_CopyQCAllMonitorItemSN] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
...
//      int QC_CopyAllMonitorItemSN(MYSQL mysqlCon, unsigned int intSourceMOSN, unsigned int intDestinationMOSN)
		intRetval = QC_CopyAllMonitorItemSN(mysqlCon, json_object_get_int(jsonMOSN_Source), json_object_get_int(jsonMOSN_Destination));

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_QC_CopyQCAllMonitorItemSN] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_QC_CopyQCAllMonitorItemSN]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_QC_CopyQCAllMonitorItemSN] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
*/
	...
	snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_QC_CopyQCControlLine]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_QC_CopyQCControlLine] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
...
//      int QC_CopyQCControlLine(MYSQL mysqlCon, unsigned int intSourceMOSN, unsigned int intDestinationMOSN)
		intRetval = QC_CopyQCControlLine(mysqlCon, json_object_get_int(jsonMOSN_Source), json_object_get_int(jsonMOSN_Destination));

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_QC_CopyQCControlLine] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_QC_CopyQCControlLine]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_QC_CopyQCControlLine] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
*/
	...
	snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_EC_CopyECControlLine]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_EC_CopyECControlLine] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
...
//      int EC_CopyECControlLine(MYSQL mysqlCon, unsigned int intSourceMOSN, unsigned int intDestinationMOSN)
		intRetval = EC_CopyECControlLine(mysqlCon, json_object_get_int(jsonMOSN_Source), json_object_get_int(jsonMOSN_Destination));

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_EC_CopyECControlLine] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_EC_CopyECControlLine]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_EC_CopyECControlLine] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
/*
    ...
    Args:
        ...
        2. jsonMOSN2-製令2
    return:
        boolIsomorphism- True代表同構, False代表非同構
*/
	char charErrMsg[LONG_STRING_SIZE];
	...
	struct json_object *jsoncharContentDataList;
	struct json_object *jsonMOSN1;
	struct json_object *jsonMOSN2;

	snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_CheckIsomorphismbyMOSN]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_CheckIsomorphismbyMOSN] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN1", &jsonMOSN1);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN2", &jsonMOSN2);

//      int DB_CheckIsomorphismbyMOSN(MYSQL mysqlCon, unsigned int intMOSN1, unsigned int intMOSN2, bool *boolIsomorphism)
		intRetval = DB_CheckIsomorphismbyMOSN(mysqlCon, json_object_get_int(jsonMOSN1), json_object_get_int(jsonMOSN2), &boolIsomorphism);
		fprintf(stderr, "=======Source:%d,Destination:%d,intRetval:%d=======\n", json_object_get_int(jsonMOSN1), json_object_get_int(jsonMOSN2),intRetval);

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "boolIsomorphism", json_object_new_boolean(boolIsomorphism));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_CheckIsomorphismbyMOSN] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_CheckIsomorphismbyMOSN]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_CheckIsomorphismbyMOSN] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
int INDEX_JSON_SetPrimaryIMM(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetPrimaryIMM]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_SetPrimaryIMM] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intIMMSN", &jsonIMMSN);

//      int IMM_SetPrimaryIMM(MYSQL mysqlCon, unsigned int intIMMSN)
		intRetval = IMM_SetPrimaryIMM(mysqlCon, json_object_get_int(jsonIMMSN));

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[SPC_SetPrimaryIMM] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetPrimaryIMM]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[SPC_SetPrimaryIMM] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
int INDEX_JSON_SetSPCQC(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	struct json_object *jsonMOSN;
	struct json_object *jsonShotSNStart;
	struct json_object *jsonSPCSN;
	struct json_object *jsonSPCQC;
	struct json_object *jsonQualityControlCLRatio;

	snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetSPCQC]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_SetSPCQC] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN", &jsonMOSN);
		json_object_object_get_ex(jsoncharContentDataList, "intSPCSN", &jsonSPCSN);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCQC", &jsonSPCQC);
		json_object_object_get_ex(jsoncharContentDataList, "doubleQualityControlCLRatio", &jsonQualityControlCLRatio);

        // int SPC_EnableSPCSNQC(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intSPCSN, bool boolSPCQC[8]);
//		intRetval = SPC_EnableSPCSNQC(mysqlCon, json_object_get_int(jsonMOSN), json_object_get_int(jsonSPCSN), json_object_get_int(jsonSPCQC));
		intRetval = QC_ConfigMonitorItemSN(mysqlCon, json_object_get_int(jsonMOSN), json_object_get_int(jsonSPCSN), json_object_get_int(jsonSPCQC), json_object_get_double(jsonQualityControlCLRatio));

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[SPC_EnableSPCSNQC] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetSPCQC]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[SPC_EnableSPCSNQC] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
int INDEX_JSON_SetSPCRule(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	struct json_object *jsonMOSN;
	struct json_object *jsonShotSNStart;
	struct json_object *jsonMonitorItemSN;
	struct json_object *jsonSPCSampleSize;
	struct json_object *jsonSPCGroupSize;
	struct json_object *jsonSPCCLRatio;
	struct json_object *jsonSPCRule1;
	struct json_object *jsonSPCRule2;
	struct json_object *jsonSPCRule3;
	struct json_object *jsonSPCRule4;
	struct json_object *jsonSPCRule5;
	struct json_object *jsonSPCRule6;
	struct json_object *jsonSPCRule7;
	struct json_object *jsonSPCRule8;
	bool boolSPCRule[8];

	snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetSPCRule]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_SetSPCRule] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN", &jsonMOSN);
		json_object_object_get_ex(jsoncharContentDataList, "intSPCSN", &jsonMonitorItemSN);
		json_object_object_get_ex(jsoncharContentDataList, "intSPCSampleSize", &jsonSPCSampleSize);
		json_object_object_get_ex(jsoncharContentDataList, "intSPCGroupSize", &jsonSPCGroupSize);
		json_object_object_get_ex(jsoncharContentDataList, "doubleSPCCLRatio", &jsonSPCCLRatio);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCRule1", &jsonSPCRule1);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCRule2", &jsonSPCRule2);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCRule3", &jsonSPCRule3);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCRule4", &jsonSPCRule4);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCRule5", &jsonSPCRule5);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCRule6", &jsonSPCRule6);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCRule7", &jsonSPCRule7);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCRule8", &jsonSPCRule8);

		boolSPCRule[0] = json_object_get_int(jsonSPCRule1);
		boolSPCRule[1] = json_object_get_int(jsonSPCRule2);
		boolSPCRule[2] = json_object_get_int(jsonSPCRule3);
		boolSPCRule[3] = json_object_get_int(jsonSPCRule4);
		boolSPCRule[4] = json_object_get_int(jsonSPCRule5);
		boolSPCRule[5] = json_object_get_int(jsonSPCRule6);
		boolSPCRule[6] = json_object_get_int(jsonSPCRule7);
		boolSPCRule[7] = json_object_get_int(jsonSPCRule8);


        // int SPC_EnableSPCSNRule(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intSPCSN, bool boolSPCRule[8]);
        // int SPC_ConfigMonitorItemSN(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intMonitorItemSN,
//+                           unsigned int intSPCSampleSize, unsigned int intSPCGroupSize,
//+                           double doubleSPCCLRatio, bool boolSPCRule[8])
		intRetval = SPC_ConfigMonitorItemSN(mysqlCon, json_object_get_int(jsonMOSN), json_object_get_int(jsonMonitorItemSN),
		json_object_get_int(jsonSPCSampleSize), json_object_get_int(jsonSPCGroupSize), json_object_get_double(jsonSPCCLRatio), boolSPCRule);

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[SPC_EnableSPCSNRule] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetSPCRule]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[SPC_EnableSPCSNRule] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
int INDEX_JSON_SetSPCRuleCL(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetSPCRuleCL]Fail to parse string:%s to json object", charContentData);
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		...
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_SetSPCRuleCL] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		// int INDEX_InsertSPCCL(MYSQL mysqlCon,unsigned int intMOSN, unsigned int intShotSN_Start,unsigned int intShotSN_End);
		//intRetval = INDEX_InsertSPCCL(mysqlCon, json_object_get_int(jsonMOSN), json_object_get_int(jsonShotSNStart), json_object_get_int(jsonShotSNEnd));
		intRetval = SPC_InsertAllSPCCL(mysqlCon, json_object_get_int(jsonMOSN), json_object_get_int(jsonShotSNEnd));

		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(0));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_SetSPCRuleCL] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_SetSPCRuleCL]Fail");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_SetSPCRuleCL] Failed"));
			json_object_put(jsoncharContentDataList);
			return EXIT_FAILURE;
		}
	}
...
int IMM_JSON_SetAutoOPCUAControl(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	else
	{
		...
		intRetval = IMM_EnableAutoOPCUAIMMParaControl(mysqlCon, json_object_get_int(jsonIMMSN), json_object_get_boolean(jsonValue));
...
/*
int MO_JSON_InsertMOAcceptCriteriaSN(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	char charErrMsg[LONG_STRING_SIZE];
	...
	struct json_object *jsonMOAcceotCriteriaSN;
	struct json_object *jsonValue;


	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_InsertMOAcceptCriteriaSN]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_InsertMOAcceptCriteriaSN] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		json_object_object_get_ex(jsoncharContentDataList, "MOAcceotCriteriaSN", &jsonMOAcceotCriteriaSN);
		json_object_object_get_ex(jsoncharContentDataList, "Value", &jsonValue);
		

		// strcpy(charIMMParaValue[IMMPARA_INJECTION_STAGE],"2.3456");
		strcpy(charIMMParaValue[IMMPARA_INJECTION_STAGE], json_object_get_string(jsonInjectStage));
		strcpy(charIMMParaValue[IMMPARA_HOLDING_STAGE], json_object_get_string(jsonHoldStage));
		strcpy(charIMMParaValue[IMMPARA_PLASTIFICATION_STAGE], json_object_get_string(jsonPlasStage));
...
int INDEX_SelectSysLog(MYSQL mysqlCon, int intLimit, int intOffset, bool boolOrderByDESC, struct json_object *jsonResponseHTTP)
{
	...
	intRetval = DB_SelectTableRowCount(mysqlCon, charTableName, &intTableCount);
	if (intRetval != EXIT_SUCCESS)
	{
...
int INDEX_SelectOPCUAVersionIndex(MYSQL mysqlCon, int intLimit, int intOffset, bool boolOrderByDESC, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	if (intLimit == 0)
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 ...
				 "'OPCUAVersionStr',OPCUAVersionID,"
...
int INDEX_SelectSPCIndex(MYSQL mysqlCon, int intLimit, int intOffset, bool boolOrderByDESC, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	if (intLimit == 0)
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 ...
				 "'RLCL',SPCCLList.RLCL"
				 ") FROM"
				 " INJPRO_Local_Data_MO_%d_Info_Config.SPCSNList AS SPCSNList,"
				 " INJPRO_Local_Data_MO_%d_Info_Meta.SPCCLList AS SPCCLList"
				 " WHERE"
...
{
	char charErrMsg[LONG_STRING_SIZE];
	struct json_object *jsoncharContentDataList, *jsonCustomSensorModelSN;
	int intRetval;
	...
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		if (json_object_object_get_ex(jsoncharContentDataList, "CustomSensorModelSN", &jsonCustomSensorModelSN))
		{
			intRetval = INDEX_MaskMOCustomSensor(mysqlCon, json_object_get_int(jsonCustomSensorModelSN));
			if (intRetval == EXIT_SUCCESS)
			{
				json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(1));
				json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("SUCCESS INDEX_JSON_MaskSensorModelIndex"));
				json_object_put(jsonCustomSensorModelSN);
				json_object_put(jsoncharContentDataList);
				return EXIT_SUCCESS;
			}
			else
...
{
	char charErrMsg[LONG_STRING_SIZE];
	struct json_object *jsoncharContentDataList, *jsonCustomSensorModelSN, *jsonSensorVendor, *jsonSensorCategory, *jsonSensorModel, *jsonSensorModelMeta;
	int intRetval;
	...
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "CustomSensorModelSN", &jsonCustomSensorModelSN);
		...
		strcpy(varCustomSensorModelSN.charSensorModelMeta, json_object_get_string(jsonSensorModelMeta));

		// int INDEX_UpdateSensor(MYSQL mysqlCon, unsigned int intCustomSensorModelSN, unsigned int intSensorCategory, const char *charSensorVendor,
		//    const char *charSensorModel, stCustomSensorModelSN varCustomSensorModelSN);
		intRetval = INDEX_UpdateMOCustomSensor(mysqlCon, json_object_get_int(jsonCustomSensorModelSN), json_object_get_int(jsonSensorCategory), json_object_get_string(jsonSensorVendor), json_object_get_string(jsonSensorModel), varCustomSensorModelSN);
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(1));
...
{
	char charErrMsg[LONG_STRING_SIZE];
	struct json_object *jsoncharContentDataList, *jsonSensorVendor, *jsonSensorCategory, *jsonSensorModel, *jsonSensorModelMeta, *jsonSensorClass;
	int intRetval;
	stCustomSensorModelSN varCustomSensorModelSN;
	unsigned int intCustomSensorModelSN;
	...
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "CustomSensorVendor", &jsonSensorVendor);
		json_object_object_get_ex(jsoncharContentDataList, "CustomSensorClass", &jsonSensorClass);   //New Add
		json_object_object_get_ex(jsoncharContentDataList, "CustomSensorCategory", &jsonSensorCategory);
		json_object_object_get_ex(jsoncharContentDataList, "CustomSensorModel", &jsonSensorModel);
		json_object_object_get_ex(jsoncharContentDataList, "CustomSensorModelMeta", &jsonSensorModelMeta);
		strcpy(varCustomSensorModelSN.charSensorModelMeta, json_object_get_string(jsonSensorModelMeta));

		//int INDEX_InsertMOCustomSensor(MYSQL mysqlCon, unsigned int intCustomSensorClass, unsigned int intCustomSensorCategory, const char *charCustomSensorVendor, const char *charCustomSensorModel, stCustomSensorModelSN varCustomSensorModelSN)
		...
		intRetval = INDEX_InsertMOCustomSensor(mysqlCon, &intCustomSensorModelSN, json_object_get_int(jsonSensorClass), json_object_get_int(jsonSensorCategory), json_object_get_string(jsonSensorVendor), json_object_get_string(jsonSensorModel), varCustomSensorModelSN);
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_InsertSensorModelIndex] SUCCESS"));
			json_object_object_add(jsonResponseHTTP, "intCustomSensorModelSN", json_object_new_int(intCustomSensorModelSN));
			json_object_put(jsonSensorVendor);
			json_object_put(jsonSensorCategory);
			json_object_put(jsonSensorModel);
			json_object_put(jsonSensorModelMeta);
...
int INDEX_SelectSensorModelIndex(MYSQL mysqlCon, int intLimit, int intOffset, bool boolOrderByDESC, struct json_object *jsonResponseHTTP)
{
	...
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 "SELECT JSON_OBJECT('CustomSensorModelSN',CustomSensorModelSN,'SensorModelMask',SensorModelMask,'SensorVendor',SensorVendor,'SensorCategory',SensorCategory,'SensorModel',SensorModel,'SensorModelMeta',SensorModelMeta) FROM %s_%s.SensorModelIndex WHERE SensorModelMask=0 ORDER BY CustomSensorModelSN %s",
				 SYS_NAME, INDEX_DATABASE_NAME, boolOrderByDESC == true ? "DESC" : "ASC");
	}
	else
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 "SELECT JSON_OBJECT('CustomSensorModelSN',CustomSensorModelSN,'SensorModelMask',SensorModelMask,'SensorVendor',SensorVendor,'SensorCategory',SensorCategory,'SensorModel',SensorModel,'SensorModelMeta',SensorModelMeta) FROM %s_%s.SensorModelIndex SensorModelMask=0 ORDER BY CustomSensorModelSN %s LIMIT %d OFFSET %d",
...
{
	char charErrMsg[LONG_STRING_SIZE];
	struct json_object *jsoncharContentDataList, *jsonProdSN, *jsonProdID, *jsonProdMeta;
	int intRetval;
	struct stProdSN prodSN;
	...
	else
	{
		...
		json_object_object_get_ex(jsoncharContentDataList, "ProdID", &jsonProdID);
		json_object_object_get_ex(jsoncharContentDataList, "ProdMeta", &jsonProdMeta);
		strcpy(prodSN.charProdMeta, json_object_get_string(jsonProdMeta));
		// int INDEX_UpdateProd(MYSQL mysqlCon, unsigned int intProdSN, unsigned int intMoldSN, const char *charProdID);
		intRetval = INDEX_UpdateProd(mysqlCon, json_object_get_int(jsonProdSN), json_object_get_string(jsonProdID), prodSN);
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("SUCCESS INDEX_JSON_ReplaceProdIndex"));
			json_object_put(jsonProdSN);
			json_object_put(jsonProdID);
			json_object_put(jsonProdMeta);
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
...
{
	char charErrMsg[LONG_STRING_SIZE];
	struct json_object *jsoncharContentDataList, *jsonMoldSN, *jsonProdID, *jsonProdMeta;
	int intRetval;
	unsigned int intProdSN;
	struct json_object *jsonRowObjectList;
	struct stProdSN prodSN;
	...
	else
	{
		...
		json_object_object_get_ex(jsoncharContentDataList, "ProdMeta", &jsonProdMeta);
		strcpy(prodSN.charProdMeta, json_object_get_string(jsonProdMeta));
		// int INDEX_InsertProd(MYSQL mysqlCon, unsigned int intMoldSN,const char *charProdID);
        // int INDEX_InsertProd(MYSQL mysqlCon, unsigned int *intProdSN, const char *charProdID, stProdSN varProdSN)
		intRetval = INDEX_InsertProd(mysqlCon, &intProdSN, json_object_get_string(jsonProdID), prodSN);
		if (intRetval == EXIT_SUCCESS)
		{
		    jsonRowObjectList = json_object_new_array();
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_InsertProdIndex] SUCCESS"));
		    json_object_object_add(jsonResponseHTTP, "intProdSN", json_object_new_int(intProdSN));
...
int INDEX_SelectProdIndex(MYSQL mysqlCon, int intLimit, int intOffset, bool boolOrderByDESC, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 "SELECT JSON_OBJECT('ProdSN',ProdSN,'ProdMask',ProdMask,'ProdStr',ProdID) FROM %s_%s.ProdIndex WHERE ProdSN=%d ORDER BY ProdSN %s",
	...
	else
	{
		...
		{
			snprintf(charStatement, MAX_STRING_SIZE,
					 "SELECT JSON_OBJECT('ProdSN',ProdSN,'ProdMask',ProdMask,'ProdStr',ProdID) FROM %s_%s.ProdIndex WHERE ProdMask=0 ORDER BY ProdSN %s",
					 SYS_NAME, INDEX_DATABASE_NAME, boolOrderByDESC == true ? "DESC" : "ASC");
		}
		else
		{
			snprintf(charStatement, MAX_STRING_SIZE,
					 "SELECT JSON_OBJECT('ProdSN',ProdSN,'ProdMask',ProdMask,'ProdStr',ProdID) FROM %s_%s.ProdIndex WHERE ProdMask=0 ORDER BY ProdSN %s LIMIT %d OFFSET %d",
					 SYS_NAME, INDEX_DATABASE_NAME, boolOrderByDESC == true ? "DESC" : "ASC", intLimit, intOffset);
		}
	}
	//Set MySQL Statement
...
int INDEX_JSON_InsertMoldIndex(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	else
	{
		...
		intRetval = INDEX_InsertMold(mysqlCon, &intMoldSN, json_object_get_string(jsonMoldVendor), json_object_get_string(jsonMoldID), varMoldSN);
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_InsertMoldIndex] SUCCESS"));
			json_object_object_add(jsonResponseHTTP, "intMoldSN", json_object_new_int(intMoldSN));
			json_object_put(jsonMoldID);
			json_object_put(jsonMoldVendor);
			json_object_put(jsonMoldMeta);
			json_object_put(jsoncharContentDataList);
...
{
	char charErrMsg[LONG_STRING_SIZE];
	struct json_object *jsoncharContentDataList, *jsonMaterialID, *jsonMaterialSN, *jsonMaterialMeta;
	int intRetval;
	struct stMaterialSN materialSN;
	...
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "MaterialID", &jsonMaterialID);
		json_object_object_get_ex(jsoncharContentDataList, "MaterialSN", &jsonMaterialSN);
		json_object_object_get_ex(jsoncharContentDataList, "MaterialMeta", &jsonMaterialMeta);
		strcpy(materialSN.charMaterialMeta, json_object_get_string(jsonMaterialMeta));
		// int INDEX_UpdateMaterial(MYSQL mysqlCon, unsigned int intMaterialSN, const char *charMaterialStr);
		intRetval = INDEX_UpdateMaterial(mysqlCon, json_object_get_int(jsonMaterialSN), json_object_get_string(jsonMaterialID), materialSN);
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("SUCCESS INDEX_JSON_ReplaceMaterialIndex"));
			json_object_put(jsonMaterialID);
			json_object_put(jsonMaterialMeta);
			json_object_put(jsonMaterialSN);
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
...
{
	char charErrMsg[LONG_STRING_SIZE];
	struct json_object *jsoncharContentDataList, *jsonMaterialID, *jsonMaterialMeta;
	int intRetval;
	struct stMaterialSN MaterialSN;
	unsigned int intMaterialSN;
	...
	else
	{
		...
		json_object_object_get_ex(jsoncharContentDataList, "MaterialMeta", &jsonMaterialMeta);
		strcpy(MaterialSN.charMaterialMeta, json_object_get_string(jsonMaterialMeta));
		// int INDEX_InsertMaterial(MYSQL mysqlCon, const char *charMaterialID);
//		strcpy(MaterialSN.charMaterialMeta, "MaterialMeta");
        // int INDEX_InsertMaterial(MYSQL mysqlCon, unsigned int *intMaterialSN, const char *charMaterialID, stMaterialSN varMaterialSN)
		intRetval = INDEX_InsertMaterial(mysqlCon, &intMaterialSN, json_object_get_string(jsonMaterialID), MaterialSN);
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[INDEX_JSON_InsertMaterialIndex] SUCCESS"));
			json_object_object_add(jsonResponseHTTP, "intMaterialSN", json_object_new_int(intMaterialSN));
			json_object_put(jsonMaterialID);
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
...
int INDEX_SelectMaterialIndex(MYSQL mysqlCon, int intLimit, int intOffset, bool boolOrderByDESC, struct json_object *jsonResponseHTTP)
{
	...
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 "SELECT JSON_OBJECT('MaterialSN',MaterialSN,'MaterialMask',MaterialMask,'MaterialStr',MaterialID) FROM %s_%s.MaterialIndex WHERE MaterialMask=0 ORDER BY MaterialSN %s",
				 SYS_NAME, INDEX_DATABASE_NAME, boolOrderByDESC == true ? "DESC" : "ASC");
	}
	else
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 "SELECT JSON_OBJECT('MaterialSN',MaterialSN,'MaterialMask',MaterialMask,'MaterialStr',MaterialID) FROM %s_%s.MaterialIndex WHERE MaterialMask=0 ORDER BY MaterialSN %s LIMIT %d OFFSET %d",
				 SYS_NAME, INDEX_DATABASE_NAME, boolOrderByDESC == true ? "DESC" : "ASC", intLimit, intOffset);
	}
	// fprintf(stderr, "charStatement:%s\n",charStatement);
	//Query MySQL Database
...
{
	char charErrMsg[LONG_STRING_SIZE];
	struct json_object *jsoncharContentDataList, *jsonIMMID, *jsonIMMStationID,
	*jsonIMMModelSN, *jsonOPCUAVersionSN, *jsonOPCUAIP, *jsonOPCUAPort,
	*jsonOPCUAUserName, *jsonOPCUAPassword, *jsonIMMModBusIP, *jsonIMMModBusPort,
	*jsonIMMMoldSignalType , *jsonIMMMoldSignalSource, *jsonIMMSN;
	int intRetval;
	char charIMMID[SMALL_STRING_SIZE];
	char charOPCUAIP[16];
	unsigned int intIMMSN;
	stIMMSN varIMMSN;
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_UpdateIMMList]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed INDEX_JSON_UpdateIMMList JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "IMMID", &jsonIMMID);
		json_object_object_get_ex(jsoncharContentDataList, "IMMSN", &jsonIMMSN);
		json_object_object_get_ex(jsoncharContentDataList, "IMMStationID", &jsonIMMStationID);
		json_object_object_get_ex(jsoncharContentDataList, "IMMModelSN", &jsonIMMModelSN);
		json_object_object_get_ex(jsoncharContentDataList, "OPCUAVersionSN", &jsonOPCUAVersionSN);
		json_object_object_get_ex(jsoncharContentDataList, "OPCUAIP", &jsonOPCUAIP);
		json_object_object_get_ex(jsoncharContentDataList, "OPCUAPort", &jsonOPCUAPort);
		json_object_object_get_ex(jsoncharContentDataList, "OPCUAUserName", &jsonOPCUAUserName);
		json_object_object_get_ex(jsoncharContentDataList, "OPCUAPassword", &jsonOPCUAPassword);
		json_object_object_get_ex(jsoncharContentDataList, "IMMModBusIP", &jsonIMMModBusIP);
		json_object_object_get_ex(jsoncharContentDataList, "IMMModBusPort", &jsonIMMModBusPort);
		json_object_object_get_ex(jsoncharContentDataList, "IMMMoldSignalSource", &jsonIMMMoldSignalSource);
		json_object_object_get_ex(jsoncharContentDataList, "IMMMoldSignalType", &jsonIMMMoldSignalType);
		strcpy(charIMMID, json_object_get_string(jsonIMMID));
		strcpy(varIMMSN.charOPCUAVersionSN, json_object_get_string(jsonOPCUAVersionSN));
		strcpy(varIMMSN.charOPCUAIP, json_object_get_string(jsonOPCUAIP));
		strcpy(varIMMSN.charOPCUAPort, json_object_get_string(jsonOPCUAPort));
		strcpy(varIMMSN.charOPCUAUserName, json_object_get_string(jsonOPCUAUserName));
		strcpy(varIMMSN.charOPCUAPassword, json_object_get_string(jsonOPCUAPassword));
		strcpy(varIMMSN.charModbusIP, json_object_get_string(jsonIMMModBusIP));
		strcpy(varIMMSN.charModbusPort, json_object_get_string(jsonIMMModBusPort));
		strcpy(varIMMSN.charModbusMoldSignalSource, json_object_get_string(jsonIMMMoldSignalSource));
		strcpy(varIMMSN.charModbusMoldSignalType, json_object_get_string(jsonIMMMoldSignalType));

//        int IMM_UpdateIMM(MYSQL mysqlCon, unsigned int intIMMSN, char charIMMID[SMALL_STRING_SIZE], unsigned int intIMMStationID,
// unsigned int intIMMModelSN, stIMMSN varIMMSN);
        intRetval = IMM_UpdateIMM(mysqlCon, json_object_get_int(jsonIMMSN), charIMMID, json_object_get_int(jsonIMMStationID),
         json_object_get_int(jsonIMMModelSN), varIMMSN);
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("SUCCESS INDEX_JSON_UpdateIMMList"));
			json_object_put(jsonIMMID);
			json_object_put(jsonIMMStationID);
			json_object_put(jsonIMMModelSN);
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed INDEX_JSON_UpdateIMMList"));
			json_object_put(jsonIMMID);
			json_object_put(jsonIMMStationID);
			json_object_put(jsonIMMModelSN);
			json_object_put(jsoncharContentDataList);
...
int INDEX_JSON_InsertIMMList(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	*jsonIMMModelSN, *jsonOPCUAVersionSN, *jsonOPCUAIP, *jsonOPCUAPort,
	*jsonOPCUAUserName, *jsonOPCUAPassword, *jsonIMMModBusIP, *jsonIMMModBusPort,
	*jsonIMMMoldSignalType , *jsonIMMMoldSignalSource;
	int intRetval;
	char charIMMID[SMALL_STRING_SIZE];
	char charOPCUAIP[16];
	unsigned int intIMMSN;
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[INDEX_JSON_InsertIMMList]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed INDEX_JSON_InsertIMMList JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
        ...
        //int IMM_InsertIMM(MYSQL mysqlCon, unsigned int *intIMMSN, char charIMMID[SMALL_STRING_SIZE], unsigned int intIMMStationID, unsigned int intIMMModelSN,
		//		  unsigned int intOPCUAVersionSN, char charOPCUAIP[16], unsigned int intOPCUAPort, stIMMSN varIMMSN);
		// INDEX_InsertIMMModel(MYSQL mysqlCon, const char *charIMMVendor, const char *charIMMModel, stIMMModelSN varIMMModelSN);
        //int IMM_InsertIMM(MYSQL mysqlCon,
//				  unsigned int *intIMMSN,
//				  char charIMMID[SMALL_STRING_SIZE],
//				  unsigned int intIMMStationID,
//				  unsigned int intIMMModelSN,
//				  stIMMSN varIMMSN)
//        int IMM_InsertIMM(MYSQL mysqlCon, unsigned int *intIMMSN, char charIMMID[SMALL_STRING_SIZE],
// unsigned int intIMMStationID, unsigned int intIMMModelSN, stIMMSN varIMMSN);
        intRetval = IMM_InsertIMM(mysqlCon, &intIMMSN, charIMMID, json_object_get_int(jsonIMMStationID),
         json_object_get_int(jsonIMMModelSN), varIMMSN);
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("SUCCESS INDEX_JSON_InsertIMMList"));
			json_object_put(jsonIMMID);
			json_object_put(jsonIMMStationID);
			json_object_put(jsonIMMModelSN);
			json_object_put(jsoncharContentDataList);
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed INDEX_JSON_InsertIMMList"));
			json_object_put(jsonIMMID);
			json_object_put(jsonIMMStationID);
			json_object_put(jsonIMMModelSN);
			json_object_put(jsoncharContentDataList);
...
int INDEX_JSON_InsertIMMModel(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	else
	{
		...
		intRetval = INDEX_InsertIMMModel(mysqlCon, &intIMMModelSN, json_object_get_string(jsonIMMVendor), json_object_get_string(jsonIMMModel), varIMMModelSN);
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("SUCCESS INDEX_JSON_InsertIMMModel"));
			json_object_object_add(jsonResponseHTTP, "intIMMModelSN", json_object_new_int(intIMMModelSN));
			json_object_put(jsonIMMVendor);
			json_object_put(jsonIMMModel);
			json_object_put(jsonIMMModelMeta);
			json_object_put(jsoncharContentDataList);
...
int INDEX_JSON_InsertAcceptCriteria(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	int intRetval;
	unsigned int intAcceptCriteriaSN;
	...
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		if (json_object_object_get_ex(jsoncharContentDataList, "AcceptCriteriaID", &jsoncharContentDataObject))
		{
            // int INDEX_InsertAcceptCriteria(MYSQL mysqlCon, unsigned int *intAcceptCriteriaSN, const char *charAcceptCriteriaName)
			intRetval = INDEX_InsertAcceptCriteria(mysqlCon, &intAcceptCriteriaSN, json_object_get_string(jsoncharContentDataObject));
			if (intRetval == EXIT_SUCCESS)
			{
				json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
				json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("SUCCESS INDEX_JSON_InsertAcceptCriteria"));
				json_object_object_add(jsonResponseHTTP, "intAcceptCriteriaSN", json_object_new_int(intAcceptCriteriaSN));
...
int INDEX_SelectAcceptCriteriaIndex(MYSQL mysqlCon, int intLimit, int intOffset, bool boolOrderByDESC, struct json_object *jsonResponseHTTP)
{
	...
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 "SELECT JSON_OBJECT('AcceptCriteriaSN',AcceptCriteriaSN,'AcceptCriteriaMask',AcceptCriteriaMask,'AcceptCriteriaName',AcceptCriteriaName) FROM %s_%s.AcceptCriteriaIndex WHERE AcceptCriteriaMask=0 ORDER BY AcceptCriteriaSN %s",
				 SYS_NAME, INDEX_DATABASE_NAME, boolOrderByDESC == true ? "DESC" : "ASC");
	}
	else
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 "SELECT JSON_OBJECT('AcceptCriteriaSN',AcceptCriteriaSN,'AcceptCriteriaMask',AcceptCriteriaMask,'AcceptCriteriaName',AcceptCriteriaName) FROM %s_%s.AcceptCriteriaIndex WHERE AcceptCriteriaMask=0 ORDER BY AcceptCriteriaSN %s LIMIT %d OFFSET %d",
				 SYS_NAME, INDEX_DATABASE_NAME, boolOrderByDESC == true ? "DESC" : "ASC", intLimit, intOffset);
	}
	// fprintf(stderr, "charStatement:%s\n",charStatement);
	//Query MySQL Database
...
int IMM_SelectIMMList(MYSQL mysqlCon, int intLimit, int intOffset, bool boolOrderByDESC, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	//Select Number of Row
	snprintf(charTableName, MEDIUM_STRING_SIZE, "%s_%s.IMMSNList", SYS_NAME, DATA_DATABASE_NAME);
	intRetval = DB_SelectTableRowCount(mysqlCon, charTableName, &intTableCount);
	if (intRetval != EXIT_SUCCESS)
	{
	...
	else
	{
		...
		if (intLimit == 0)
		{
			snprintf(charStatement, MAX_STRING_SIZE,
					 ...
					 "'IMMInsertTime',IMMInsertTime,"
					 "'IMMLastUpdateTime',IMMLastUpdateTime"
					 ") FROM %s_%s.IMMSNList ORDER BY IMMSN %s",
		...
		else
		{
			snprintf(charStatement, MAX_STRING_SIZE,
					 ...
					 "'IMMInsertTime',IMMInsertTime,"
					 "'IMMLastUpdateTime',IMMLastUpdateTime"
					 ") FROM %s_%s.IMMSNList ORDER BY IMMSN %s LIMIT %d OFFSET %d",
	...
	if (intRetval)
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[IMM_SelectIMMList]Fail to select %s_%s.IMMSNList (%d):%s",
...
int MO_SelectMOList(MYSQL mysqlCon, int intLimit, int intOffset, bool boolOrderByDESC, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	//Select Number of Row
	snprintf(charTableName, MEDIUM_STRING_SIZE, "%s_%s_%s.MOSNList", SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME);
	intRetval = DB_SelectTableRowCount(mysqlCon, charTableName, &intTableCount);
	if (intRetval != EXIT_SUCCESS)
	{
	...
	if (intMOSN != 0)
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 ...
				 ") FROM %s_%s_%s.MOSNList WHERE MOSN=%d ORDER BY MOSN %s",
	...
	else
	{
		...
		if (intLimit == 0)
		{
			snprintf(charStatement, MAX_STRING_SIZE,
					 ...
					 "'ActualEndTime',ActualEndTime,"
					 "'MOLastUpdateTime',MOLastUpdateTime"
					 ") FROM %s_%s_%s.MOSNList ORDER BY MOSN %s",
		...
		else
		{
			snprintf(charStatement, MAX_STRING_SIZE,
					 ...
					 "'ActualEndTime',ActualEndTime,"
					 "'MOLastUpdateTime',MOLastUpdateTime"
					 ") FROM %s_%s_%s.MOSNList ORDER BY MOSN %s LIMIT %d OFFSET %d",
	...
	if (intRetval)
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectMOList]Fail to select %s_%s_%s.MOSNList (%d):%s",
...
int MO_SelectSPCName(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	int intRetval;
	int intLogSN;
	char charSPCSNName[SMALL_STRING_SIZE];
	int intMOSN;
	int intSPCSN;

	intMOSN = regexGetRequestQueryString_MOSN(charQueryString);
	intSPCSN = regexGetRequestQueryString_SPCSN(charQueryString);
	//int SPC_GetSPCName(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intSPCSN, char *charSPCSNName)
	//  DB_SelectMonitorItemDisplayName(mysqlCon, *intMOSN, intMonitorItemSN, charMonitorItemDisplayName);
	intRetval = DB_SelectMonitorItemDisplayName(mysqlCon, intMOSN, intSPCSN, charSPCSNName);
	if (intRetval != EXIT_SUCCESS)
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectSPCName]Fail to get Name of SPCSN %d", intSPCSN);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed"));
		return EXIT_FAILURE;
	...
	json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(1));
	json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("SUCCESS"));
	json_object_object_add(jsonResponseHTTP, "Data", json_object_new_string(charSPCSNName));
...
int MO_SelectMOShotCycleTime(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	// INJPRO_Data_MO_4_RawData.ShotSNList
	char charStatement[MAX_STRING_SIZE];
	char charErrMsg[LONG_STRING_SIZE];
	int intRetval;
	int intLogSN;
	struct json_object *jsonRowObjectList;
	int intTableCount;
	char charTableName_ShotSNList[MEDIUM_STRING_SIZE];
	int intMOSN;
	int intShotSN;
	...
	snprintf(charTableName_ShotSNList, MEDIUM_STRING_SIZE, "%s_%s_%s_%d_RawData.ShotSNList", SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME, intMOSN);
	intRetval = DB_SelectTableRowCount(mysqlCon, charTableName_ShotSNList, &intTableCount);
	if (intRetval != EXIT_SUCCESS)
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectMOShotCycleTime]Fail to select COUNT(*) of %s_%s_%s_%d_RawData.ShotSNList (%d):%s",
    ...
    snprintf(charStatement, MAX_STRING_SIZE,
                "SELECT "
                "	JSON_OBJECT('CycleTime' , CycleTime) "
                "FROM "
                "	%s_%s_%s_%d_RawData.ShotSNList "
                "WHERE "
                "	ShotSN = %d;  ",
	...
	if (intRetval)
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectMOShotCycleTime]Fail to select %s_%s_%s_%d_RawData.ShotSNList (%d):%s",
				 SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME, intMOSN, mysql_errno(&mysqlCon), mysql_error(&mysqlCon));
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed"));
	...
	while ((mysqlRow = mysql_fetch_row(mysqlResult)) != NULL)
	{
		if (is_error(json_tokener_parse(mysqlRow[0])))
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectMOShotCycleTime]Fail to parse string:%s to json object", mysqlRow[0]);
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed"));
			json_object_object_add(jsonResponseHTTP, "TableCount", json_object_new_int(intTableCount));
...
int MO_SelectCustomSensorSN_TableSN(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	int intTableCount;
	int intSensorCount;
	char charTableName_CustomSensorSN_TableSN[MEDIUM_STRING_SIZE];
	char charTableName_CustomSensorSNList[MEDIUM_STRING_SIZE];
	int intMOSN;
	int intShotSN;
	...
	intMOSN = regexGetRequestQueryString_MOSN(charQueryString);
	intShotSN = regexGetRequestQueryString_ShotSN(charQueryString);
	snprintf(charTableName_CustomSensorSNList, MEDIUM_STRING_SIZE, "%s_%s_%s_%d_Info_Meta.MOCustomSensorSNList", SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME, intMOSN);
	intRetval = DB_SelectTableRowCount(mysqlCon, charTableName_CustomSensorSNList, &intSensorCount);
	if (intRetval != EXIT_SUCCESS)
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[CustomSensorSNList]Fail to select COUNT(*) of %s_%s_%s_%d_Info_Meta.MOCustomSensorSNList (%d):%s",
				 SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME, intMOSN, mysql_errno(&mysqlCon), mysql_error(&mysqlCon));
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed"));
	...
	for (int i = 1; i <= intSensorCount; i++)
	{
		...
		// snprintf(charTableName_CustomSensorSN_TableSN, MEDIUM_STRING_SIZE, "%s_%s_%s_%d_RawData_MoldSensor.CustomSensorSN%d_TableSN1", SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME,intMOSN,i);
		snprintf(charStatement, MAX_STRING_SIZE,
				 "SELECT JSON_OBJECT("
				 "'x',ElapsedTime,"
				 "'y',SensorValue"
				 ") FROM %s_%s_%s_%d_RawData_CustomSensor.MOCustomSensorSN%d_TableSN1 WHERE ShotSN=%d ORDER BY ElapsedTime ASC",
		...
		if (intRetval)
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectCustomSensorSN_TableSN]Fail to select %s_%s_%s_%d_RawData_CustomSensor.MOCustomSensorSN%d_TableSN1 (%d):%s",
		...
		while ((mysqlRow = mysql_fetch_row(mysqlResult)) != NULL)
		{
			if (is_error(json_tokener_parse(mysqlRow[0])))
			{
				snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectCustomSensorSN_TableSN]Fail to parse string:%s to json object", mysqlRow[0]);
				SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
				json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
				json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed"));
				return EXIT_FAILURE;
...
int MO_SelectSPCFeatureValueList(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	snprintf(charTableName, MEDIUM_STRING_SIZE, "%s_%s_%s_%d_RawData_FeatureValue.CustomSensorSN1", SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME, intMOSN);
	intRetval = DB_SelectTableRowCount(mysqlCon, charTableName, &intTableCount);
	if (intRetval != EXIT_SUCCESS)
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectSPCFeatureValueList]Fail to select COUNT(*) of %s_%s.CustomSensorSN1 (%d):%s",
				 SYS_NAME, INDEX_DATABASE_NAME, mysql_errno(&mysqlCon), mysql_error(&mysqlCon));
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed"));
	...
	if (intShotSN != 0)
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 ...
				 ") FROM "
				 "%s_%s_%s_%d_RawData_FeatureValue.CustomSensorSN1 s1,"
...
int MO_SelectMOAcceptCriteriaSN(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	if (intShotSN != 0)
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 ...
				 "WHERE "
				 "s1.ShotSN = a1.ShotSN and s1.ShotSN = a2.ShotSN and s1.ShotSN=%d",
	...
	else
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 ...
				 "%s_%s_%s_%d_RawData.ShotSNList s1 "
				 "WHERE "
				 "s1.ShotSN = a1.ShotSN and s1.ShotSN = a2.ShotSN ORDER BY s1.ShotSN DESC",
...
int MO_SelectIMMSensorSNList(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	if (intShotSN != 0)
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 ...
				 "'MoldClampingTime',MoldClampingTime/1000,"
				 "'MoldReleasingTime',MoldReleasingTime/1000,"
				 "'CusionVolume',CusionVolume/10000,"
				 "'GateClosingTime',GateClosingTime/1000,"
				 //"'InjectionTime',InjectionTime/1000000,"
				 "'InjectionTime',InjectionTime/1000,"
				 //"'PlastificationTime',PlastificationTime/1000000,"
				 "'PlastificationTime',PlastificationTime/1000,"
				 //"'VPChangeOverPosition',VPChangeOverPosition/1.5205309,"
				 "'VPChangeOverPosition',VPChangeOverPosition/10000,"
				 //"'EndPlastificationPosition',EndPlastificationPosition,"
				 "'EndPlastificationPosition',EndPlastificationPosition/10000,"
				 //"'MaxInjectionPressure',MaxInjectionPressure/13.0514053,"
				 "'MaxInjectionPressure',MaxInjectionPressure/1000,"
				 //"'VPChangeOverPressure',VPChangeOverPressure/13.0514053,"
				 "'VPChangeOverPressure',VPChangeOverPressure/1000,"
				 //"'BackPressure',BackPressure/13.0514053,"
				 "'BackPressure',BackPressure/1000,"
				 "'Nozzle1Temperature',Nozzle1Temperature/10,"
				 "'Nozzle2Temperature',Nozzle2Temperature/10,"
				 "'Nozzle3Temperature',Nozzle3Temperature/10,"
				 "'Nozzle4Temperature',Nozzle4Temperature/10,"
				 "'Nozzle5Temperature',Nozzle5Temperature/10,"
				 //"'EndHoldingPosition',EndHoldingPosition,"
				 "'EndHoldingPosition',EndHoldingPosition/10000,"
				 "'ScrewRPM',ScrewRPM,"
				 //"'ScrewSuckBackPosition',ScrewSuckBackPosition/0.2303835"
				 "'ScrewSuckBackPosition',ScrewSuckBackPosition/10000"
...
int MO_SelectMOAcceptCriteriaSN1(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	snprintf(charStatement, MAX_STRING_SIZE, "SELECT COUNT(*) FROM `INJPRO_Local_Data_MO_%d_RawData`.ShotSNList AS a LEFT JOIN `INJPRO_Local_Data_MO_%d_RawData_AcceptCriteria`.MOAcceptCriteriaSN1 AS b ON a.ShotSN = b.ShotSN WHERE b.ActualBool is not null", intMOSN, intMOSN);
	intRetval = mysql_query(&mysqlCon, charStatement);
...
int MO_SelectCustomSensorSNList(MYSQL mysqlCon, struct json_object *jsonResponseHTTP, char *charQueryString)
{
	...
	intMOSN = regexGetRequestQueryString_MOSN(charQueryString);
	//Select Number of RowtINJPRO_Data_MO_2_
	snprintf(charTableName, MEDIUM_STRING_SIZE, "%s_%s_%s_%d_Info_Meta.CustomSensorSNList", SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME, intMOSN);
	intRetval = DB_SelectTableRowCount(mysqlCon, charTableName, &intTableCount);
	if (intRetval != EXIT_SUCCESS)
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectCustomSensorSNList]Fail to select COUNT(*) of %s_%s_%s_%d_Info_Meta.CustomSensorSNList (%d):%s",
				 SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME, intMOSN, mysql_errno(&mysqlCon), mysql_error(&mysqlCon));
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed"));
	...
	if (intMOSN != 0)
	{
		snprintf(charStatement, MAX_STRING_SIZE,
				 "SELECT JSON_OBJECT("
				 "'CustomSensorSN',CustomSensorSN,"
				 "'CustomSensorMeta',CustomSensorMeta"
				 ") FROM %s_%s_%s_%d_Info_Meta.CustomSensorSNList",
				 SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME, intMOSN);
	}
	else
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectCustomSensorSNList]Fail to select %s_%s_%s_%d_Info_Meta.CustomSensorSNList (%d):%s",
				 SYS_NAME, DATA_DATABASE_NAME, MO_DATABASE_NAME, intMOSN, mysql_errno(&mysqlCon), mysql_error(&mysqlCon));
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed"));
	...
	while ((mysqlRow = mysql_fetch_row(mysqlResult)) != NULL)
	{
		if (is_error(json_tokener_parse(mysqlRow[0])))
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_SelectCustomSensorSNList]Fail to parse string:%s to json object", mysqlRow[0]);
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("Failed"));
			json_object_object_add(jsonResponseHTTP, "TableCount", json_object_new_int(intTableCount));
...
int INDEX_JSON_SetMOAcceptCriteriaActualValue_Predict(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	else
	{
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN", &jsonMOSN);
		json_object_object_get_ex(jsoncharContentDataList, "intShotSN", &jsonShotSN);
		json_object_object_get_ex(jsoncharContentDataList, "intMOAcceptCriteriaSN", &jsonMOAcceptCriteriaSN);
		json_object_object_get_ex(jsoncharContentDataList, "charValue", &jsonActualValue);
...
//		intRetval = MO_InsertMOAcceptCriteriaActualValue(mysqlCon, json_object_get_int(jsonMOSN), json_object_get_int(jsonShotSN), json_object_get_int(jsonMOAcceptCriteriaSN), charActualValue);
		intRetval = MO_InsertMOAcceptCriteriaPredictValue(mysqlCon, json_object_get_int(jsonMOSN), json_object_get_int(jsonShotSN), json_object_get_int(jsonMOAcceptCriteriaSN), charActualValue);
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(1));
...
int MO_JSON_UpdateMOList(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	stMOCustomSensorSN varCustomSensorSN;
	struct json_object *jsoncharContentDataList;
	...
	struct json_object *jsonintMOSN;
	...
	struct json_object *jsonintPiecePerShot;
	...
	struct json_object *jsonintCustomSensorModelSN;
	struct json_object *jsonintCustomSensorChannelSN;
	struct json_object *jsondoubleCustomSensorConvertRatio;
	struct json_object *jsonvarCustomSensorSN;
	...
	struct json_object *jsoncharAcceptCriteriaMinTH;
	struct json_object *jsoncharAcceptCriteriaMaxTH;
	...
	else
	{
		// fprintf(stderr, "charStatement:%s\n", charContentData);
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN", &jsonintMOSN);
		...
		json_object_object_get_ex(jsoncharContentDataList, "intPiecePerShot", &jsonintPiecePerShot);
		...
		fprintf(stderr,
				...
				json_object_get_int(jsonintMOSN),
				...
				json_object_get_int(jsonintPiecePerShot),
...
//int MO_UpdateMO(MYSQL mysqlCon, unsigned int intMOSN, const char *charMOID,
//				unsigned int intIMMSN, unsigned int intProdSN, unsigned int intMoldSN, unsigned int intMaterialSN,
//				struct tm tmExpectedStartTime, struct tm tmExpectedEndTime, unsigned int intExpectedProductVolume);
...
//				unsigned int intPiecePerShot, unsigned int intExpectedProdVolume)
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "MOSN", json_object_new_int(intMOSN));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_UpdateMOList] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_UpdateMOList] Failed MO_UpdateMO");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_UpdateMOList] Failed MO_UpdateMO"));
			return EXIT_FAILURE;
		}
	}
}
...
int MO_JSON_SetMOList(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	//     "SensorSNList": 2}
	// { "intCustomSensorModelSN": 4, "intCustomSensorChannelSN": 3, "doubleCustomSensorConvertRatio": 1, "varCustomSensorSN": "Pressure A" }
	...
	else
	{
		...
		if (intRetval == EXIT_SUCCESS)
		{
			for (i = 0; i < json_object_array_length(jsonSensorSNListData); i++)
			{
				...
				/* Get results info */
				json_object_object_get_ex(jsonTempSensorSNListDataObject, "intCustomSensorModelSN", &jsonintCustomSensorModelSN);
				json_object_object_get_ex(jsonTempSensorSNListDataObject, "intMOSensorChannelSN", &jsonintCustomSensorChannelSN);
				json_object_object_get_ex(jsonTempSensorSNListDataObject, "doubleMOSensorConvertRatio", &jsondoubleCustomSensorConvertRatio);
				json_object_object_get_ex(jsonTempSensorSNListDataObject, "varMOSensorSN", &jsonvarCustomSensorSN);
				fprintf(stderr,
						"intCustomSensorModelSN:%d\n"
						"intCustomSensorChannelSN:%d\n"
						"doubleCustomSensorConvertRatio:%f\n"
						"varMOSensorSN:%s\n",
						json_object_get_int(jsonintCustomSensorModelSN),
						json_object_get_int(jsonintCustomSensorChannelSN),
						json_object_get_double(jsondoubleCustomSensorConvertRatio),
						json_object_get_string(jsonvarCustomSensorSN));

				/* Start Insert Sensor */
				strcpy(varCustomSensorSN.charMOCustomSensorMeta, json_object_get_string(jsonvarCustomSensorSN));
                ...
                //int MO_InsertMOCustomSensorSNList(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intCustomSensorModelSN, unsigned int intMOCustomSensorChannelSN, double doubleMOCustomSensorConvertRatio, stMOCustomSensorSN varMOCustomSensorSN)
				intRetval = MO_InsertMOCustomSensorSNList(
					mysqlCon,
					intMOSN,
					//2, // 1: IMM Sensor, 2: Cavity Sensor //New Add
					json_object_get_int(jsonintCustomSensorModelSN),
					json_object_get_int(jsonintCustomSensorChannelSN),
					json_object_get_double(jsondoubleCustomSensorConvertRatio),
					varCustomSensorSN);
				...
				{
					snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetMOList] Failed MO_InsertCustomSensorSNList");
					SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
					json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
					json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOList] Failed MO_InsertCustomSensorSNList"));
					return EXIT_FAILURE;
				}
			}
			for (j = 0; j < json_object_array_length(jsonAcceptCriteriaSNListData); j++)
			{
				...
				json_object_object_get_ex(jsonTempAcceptCriteriaSNListDataObject, "charAcceptCriteriaMinTH", &jsoncharAcceptCriteriaMinTH);
				json_object_object_get_ex(jsonTempAcceptCriteriaSNListDataObject, "charAcceptCriteriaMaxTH", &jsoncharAcceptCriteriaMaxTH);
				fprintf(stderr,
						"intMOAcceptCriteriaSN:%d\n"
						"intAcceptCriteriaClass:%d\n"
						"charAcceptCriteriaUnit:%s\n"
						"varAcceptCriteriaSN:%s\n"
						"charAcceptCriteriaMinTH:%s\n"
						"charAcceptCriteriaMaxTH:%s\n",
						...
						json_object_get_string(jsoncharAcceptCriteriaMinTH),
						json_object_get_string(jsoncharAcceptCriteriaMaxTH)
						);
				strcpy(varMOAcceptCriteriaSN.charAcceptCriteriaMeta, json_object_get_string(jsonvarAcceptCriteriaSN));
				strcpy(varMOAcceptCriteriaSN.charAcceptCriteriaMinTH, json_object_get_string(jsoncharAcceptCriteriaMinTH));
				strcpy(varMOAcceptCriteriaSN.charAcceptCriteriaMaxTH, json_object_get_string(jsoncharAcceptCriteriaMaxTH));
			...
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "MOSN", json_object_new_int(intMOSN));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOList] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
	...
	// int MO_InsertCustomSensorSNList(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intCustomSensorModelSN, unsigned int intCustomSensorChannelSN,
	// 							double doubleCustomSensorConvertRatio, stCustomSensorSN varCustomSensorSN);
...
int MO_JSON_ResetOPCUA(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_ResetOPCUA]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_ResetOPCUA] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		fprintf(stderr,
				"intIMMSN:%d\n",
				json_object_get_int(jsonintIMMSN));
		intRetval = OPCUA_ResetOPCUAServer(
			mysqlCon,
			json_object_get_int(jsonintIMMSN));
		if (intRetval == EXIT_SUCCESS)
		{
			json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(1));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_ResetOPCUA] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_ResetOPCUA] Failed OPCUA_ResetOPCUAServer");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_ResetOPCUA] Failed OPCUA_ResetOPCUAServer"));
			return EXIT_FAILURE;
		}
	}
}
...
int MO_JSON_UpdateMOConfigAllMonitorItemSN(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	struct json_object *jsonintMOSN;
	struct json_object *jsonintSPCSampleSize;
	struct json_object *jsonintSPCGroupSize;
	struct json_object *jsondoubleSPCCLRatio;

	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_UpdateMOConfigAllMonitorItemSN]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_UpdateMOConfigAllMonitorItemSN] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN", &jsonintMOSN);
		json_object_object_get_ex(jsoncharContentDataList, "intSPCSampleSize", &jsonintSPCSampleSize);
		json_object_object_get_ex(jsoncharContentDataList, "intSPCGroupSize", &jsonintSPCGroupSize);
		json_object_object_get_ex(jsoncharContentDataList, "doubleSPCCLRatio", &jsondoubleSPCCLRatio);
		fprintf(stderr,
				"intMOSN:%d\n"
				"intSPCSampleSize:%d\n"
				"intSPCGroupSize:%d\n"
				"doubleSPCCLRatio:%f\n",
				json_object_get_int(jsonintMOSN),
				json_object_get_int(jsonintSPCSampleSize),
				json_object_get_int(jsonintSPCGroupSize),
				json_object_get_double(jsondoubleSPCCLRatio));
		intRetval = SPC_ConfigAllMonitorItemSN(
			mysqlCon,
			json_object_get_int(jsonintMOSN),
			json_object_get_int(jsonintSPCSampleSize),
			json_object_get_int(jsonintSPCGroupSize),
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_UpdateMOConfigAllMonitorItemSN] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_UpdateMOConfigAllMonitorItemSN] Failed MO_Update_ConfigALLMonitroItemSN");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_UpdateMOConfigAllMonitorItemSN] Failed MO_Update_ConfigALLMonitroItemSN"));
			return EXIT_FAILURE;
		}
	}
}
...
int MO_JSON_SetMOLotNum(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	struct json_object *jsonintMOSN;
	struct json_object *jsonintShotSN;
	struct json_object *jsonCustomSN;

	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetMOLotNum]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOLotNum] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN", &jsonintMOSN);
		json_object_object_get_ex(jsoncharContentDataList, "intShotSN", &jsonintShotSN);
		json_object_object_get_ex(jsoncharContentDataList, "CustomSN", &jsonCustomSN);
		strcpy(charCustomSN, json_object_get_string(jsonCustomSN));
		fprintf(stderr,
				"intMOSN:%d\n"
				"intShotSN:%d\n"
				"CustomSN:%s\n",
				json_object_get_int(jsonintMOSN),
				json_object_get_int(jsonintShotSN),
				charCustomSN);
		intRetval = DB_UpdateCustomSN(
			mysqlCon,
			json_object_get_int(jsonintMOSN),
			json_object_get_int(jsonintShotSN),
			charCustomSN);
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOLotNum] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetMOLotNum] Failed MO_StartMOLotNum");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOLotNum] Failed MO_UpdateLotNum"));
			return EXIT_FAILURE;
		}
	}
}
...
int MO_JSON_SetMOStart(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetMOStart]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOStart] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOStart] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetMOStart] Failed MO_StartMOonIMM");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOStart] Failed MO_StarMOonIMM"));
			return EXIT_FAILURE;
		}
	}
}
...
int MO_JSON_SetMOStop(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
    //int MO_StopMOonIMM(MYSQL mysqlCon, unsigned int intIMMSN, unsigned int intFINISHED);
	int intRetval;
	char charErrMsg[LONG_STRING_SIZE];
	struct json_object *jsoncharContentDataList;

	struct json_object *jsonintFINISHED;
	struct json_object *jsonintIMMSN;

	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetMOStop]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOStop] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intIMMSN", &jsonintIMMSN);
		json_object_object_get_ex(jsoncharContentDataList, "intFINISHED", &jsonintFINISHED);
		fprintf(stderr,
				"intIMMSN:%d\n"
				"intMOSN:%d\n",
				json_object_get_int(jsonintIMMSN),
				json_object_get_int(jsonintFINISHED));
		intRetval = MO_StopMOonIMM(
			mysqlCon,
			json_object_get_int(jsonintIMMSN),
			json_object_get_int(jsonintFINISHED)
			);
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOStop] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetMOStop] Failed MO_StopMOonIMM");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetMOStop] Failed MO_StarMOonIMM"));
			return EXIT_FAILURE;
		}
	}
}
...
int MO_JSON_SetSPCRuleAlarmRead(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	struct json_object *jsonintMOSN;
	struct json_object *jsonintSPCRuleAlarmSN;
	struct json_object *jsonboolSPCRuleAlarmRead;

	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetSPCRuleAlarmRead]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetSPCRuleAlarmRead] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN", &jsonintMOSN);
		json_object_object_get_ex(jsoncharContentDataList, "intSPCRuleAlarmSN", &jsonintSPCRuleAlarmSN);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCRuleAlarmRead", &jsonboolSPCRuleAlarmRead);
		fprintf(stderr,
				"intMOSN:%d\n"
				"intSPCRuleAlarmSN:%d\n"
				"boolSPCRuleAlarmRead:%d\n",
				json_object_get_int(jsonintMOSN),
				json_object_get_int(jsonintSPCRuleAlarmSN),
				json_object_get_boolean(jsonboolSPCRuleAlarmRead)
				);
//		int SPC_UpdateSPCAlarmRead(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intSPCAlarmSN, bool boolSPCAlarmRead)
		intRetval = SPC_UpdateSPCAlarmRead(
			mysqlCon,
			json_object_get_int(jsonintMOSN),
			json_object_get_int(jsonintSPCRuleAlarmSN),
			json_object_get_boolean(jsonboolSPCRuleAlarmRead)
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetSPCRuleAlarmRead] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetSPCRuleAlarmRead] Failed DB_UpdateSPCRuleAlarmRead");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetSPCRuleAlarmRead] Failed DB_UpdateSPCRuleAlarmRead"));
			return EXIT_FAILURE;
		}
	}
}
...
int MO_JSON_SetSPCQCAlarmRead(MYSQL mysqlCon, char *charContentData, struct json_object *jsonResponseHTTP)
{
	...
	struct json_object *jsonintMOSN;
	struct json_object *jsonintSPCQCAlarmSN;
	struct json_object *jsonboolSPCQCAlarmRead;

	if (is_error(json_tokener_parse(charContentData)))
	{
		snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetSPCQCAlarmRead]Fail to parse string:%s to json object", charContentData);
		SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
		json_object_object_add(jsonResponseHTTP, "Result", json_object_new_int(0));
		json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetSPCQCAlarmRead] Failed JSON parse"));
		return EXIT_FAILURE;
	}
	else
	{
		...
		jsoncharContentDataList = json_tokener_parse(charContentData);
		json_object_object_get_ex(jsoncharContentDataList, "intMOSN", &jsonintMOSN);
		json_object_object_get_ex(jsoncharContentDataList, "intSPCQCAlarmSN", &jsonintSPCQCAlarmSN);
		json_object_object_get_ex(jsoncharContentDataList, "boolSPCQCAlarmRead", &jsonboolSPCQCAlarmRead);
		fprintf(stderr,
				"intMOSN:%d\n"
				"intSPCQCAlarmSN:%d\n"
				"boolSPCQCAlarmRead:%d\n",
				json_object_get_int(jsonintMOSN),
				json_object_get_int(jsonintSPCQCAlarmSN),
				json_object_get_boolean(jsonboolSPCQCAlarmRead)
				);
//				int QC_UpdateQCAlarmRead(MYSQL mysqlCon, unsigned int intMOSN, unsigned int intQualityControlAlarmSN, bool boolQualityControlAlarmRead)
		intRetval = QC_UpdateQCAlarmRead(
			mysqlCon,
			json_object_get_int(jsonintMOSN),
			json_object_get_int(jsonintSPCQCAlarmSN),
			json_object_get_boolean(jsonboolSPCQCAlarmRead)
		...
		{
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetSPCQCAlarmRead] SUCCESS"));
			json_object_put(jsoncharContentDataList);
			return EXIT_SUCCESS;
		}
		else
		{
			snprintf(charErrMsg, LONG_STRING_SIZE, "[MO_JSON_SetSPCQCAlarmRead] Failed DB_UpdateSPCQCAlarmRead");
			SYS_InsertSysErrMsg(mysqlCon, ERRCLASS_WEBSERVICE, 0, 0, mysql_errno(&mysqlCon), charErrMsg);
			json_object_object_add(jsonResponseHTTP, "ErrSN", json_object_new_int(intRetval));
			json_object_object_add(jsonResponseHTTP, "Msg", json_object_new_string("[MO_JSON_SetSPCQCAlarmRead] Failed DB_UpdateSPCQCAlarmRead"));
			return EXIT_FAILURE;
		}
	}
}
